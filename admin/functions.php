...
function get_all_user_posts(){
    return query("SELECT * FROM posts WHERE post_user=".loggedInUserId()."");
}
...
function get_all_posts_user_comments(){
    ...
    WHERE post_user=".loggedInUserId()."");

}

function get_all_user_categories(){
    return query("SELECT * FROM categories WHERE post_user=".loggedInUserId()."");
}

function get_all_user_published_posts(){
    return query("SELECT * FROM posts WHERE post_user=".loggedInUserId()." AND post_status='published'");
}

function get_all_user_draft_posts(){
    return query("SELECT * FROM posts WHERE post_user=".loggedInUserId()." AND post_status='draft'");
}
...
function get_all_user_approved_posts_comments(){
    return query("SELECT * FROM posts
    INNER JOIN comments ON posts.post_id = comments.comment_post_id
    WHERE post_user=".loggedInUserId()." AND comment_status='approved'");
}
...
function get_all_user_unapproved_posts_comments(){
    return query("SELECT * FROM posts
    INNER JOIN comments ON posts.post_id = comments.comment_post_id
    WHERE post_user=".loggedInUserId()." AND comment_status='unapproved'");
}
...
function confirmQuery($result) {
    ...
    if(!$result ) {
          ...
          die("QUERY NasLED ." . mysqli_error($connection));
...
function register_user($username, $email, $password){
 ...
 function login_user($username, $password)
 {
     ...
     if (!$select_user_query) {
         ...
         die("QUERY NAILED" . mysqli_error($connection));
